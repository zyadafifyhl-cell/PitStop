      ...
      <Svg width="100%" height="100%" viewBox="0 0 400 800" preserveAspectRatio="xMidYMid slice">
        <Defs>
          <LinearGradient id="bgGrad" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <Stop offset="42%" stopColor={theme.bgElevated} stopOpacity={1} />
            <Stop offset="100%" stopColor={theme.bg} stopOpacity={1} />
          </LinearGradient>
          <LinearGradient id="ambientSweep" x1="0%" y1="10%" x2="90%" y2="90%">
            <Stop offset="0%" stopColor={topGlow} stopOpacity={0.06} />
            <Stop offset="45%" stopColor={topGlow} stopOpacity={0.025} />
            <Stop offset="100%" stopColor={topGlow} stopOpacity={0} />
          </LinearGradient>
          <RadialGradient id="topHalo" cx="76%" cy="18%" r="62%">
            <Stop offset="0%" stopColor={topGlow} stopOpacity={0.08} />
            <Stop offset="42%" stopColor={topGlow} stopOpacity={0.03} />
            <Stop offset="100%" stopColor={topGlow} stopOpacity={0} />
          </RadialGradient>
          <RadialGradient id="bottomHalo" cx="18%" cy="84%" r="56%">
            <Stop offset="0%" stopColor={bottomGlow} stopOpacity={0.07} />
            <Stop offset="52%" stopColor={bottomGlow} stopOpacity={0.025} />
        ...
        {variant === 'welcome' ? (
          <>
            <Rect x="-20" y="0" width="440" height="800" fill="url(#ambientSweep)" />
            <Ellipse cx="48" cy="86" rx="78" ry="56" fill={theme.text} opacity={0.025} />
            <Ellipse cx="360" cy="740" rx="96" ry="66" fill={theme.text} opacity={0.025} />
