...
const styles = StyleSheet.create({
  ...
  primaryBtn: { borderRadius: 9, paddingVertical: 14, alignItems: 'center' },
  primaryBtnText: { fontSize: 15, fontWeight: '600', letterSpacing: 0.5 },
  secondaryBtn: { borderWidth: 1, borderRadius: 9, paddingVertical: 14, alignItems: 'center', marginTop: 10 },
