-- =============================================================================
-- PitStop 2.0 — RUN THIS ON YOUR EXISTING SUPABASE (SQL Editor)
-- You already have: profiles, spare_parts, shops, bookings, etc.
-- DO NOT re-run your old bootstrap script.
-- Copy this ENTIRE file → Supabase Dashboard → SQL Editor → Run
-- =============================================================================

-- ---------------------------------------------------------------------------
-- PART 1 — spare_parts → store (app expects "store" table)
-- ---------------------------------------------------------------------------
...
-- Link Auth users → public.users (customers from signup + owners from owner_email)
...
-- Done. Refresh Table Editor — you should see: users, shop_branches, branch_employees, branch_services, store
